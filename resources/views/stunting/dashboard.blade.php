    ...
    <div x-data="stuntingDashboard()" x-init="initDashboard()">
                ...
                <div class="inline-block w-full max-w-2xl p-6 my-8 text-left align-middle transition-all transform bg-white shadow-2xl rounded-3xl z-10 border border-slate-100">
                    <div class="flex items-center justify-between pb-3 border-b border-slate-100">
                        <div>
                            ...
                            <p class="text-xs text-slate-500">Perubahan data akan langsung terupdate di tabel dan grafik</p>
                        </div>
                    ...
                    <form @submit.prevent="saveEditPatient()" class="mt-4 space-y-3.5 text-xs max-h-[75vh] overflow-y-auto pr-1">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            ...
                            <div>
                                <label class="block font-semibold text-slate-700 mb-1">Naik BB</label>
                        ...
                        <div class="mt-5 pt-3 border-t border-slate-100 flex items-center justify-end gap-2">
                            ...
                            <button type="submit"
                                class="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-semibold shadow-xs cursor-pointer">Simpan Perubahan</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div x-show="showAddModal" x-cloak class="fixed inset-0 z-[9999] overflow-y-auto" style="display: none;">
            <div class="min-h-screen px-4 text-center flex items-center justify-center py-8">
                ...
                <div class="inline-block w-full max-w-2xl text-left align-middle transition-all transform bg-white shadow-2xl rounded-3xl z-10 border border-slate-100 overflow-hidden">
                    {{-- Header --}}
                    <div class="px-6 pt-5 pb-4 border-b border-slate-100 flex items-center justify-between gap-3">
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">Isi formulir manual atau gunakan bantuan AI e-PPGBM</p>
                        </div>
                    ...
                    <div class="px-6 py-5 max-h-[70vh] overflow-y-auto">
                        ...
                        <div x-show="addModalTab === 'manual'" class="space-y-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div class="sm:col-span-2">
                                    <label class="block text-[11px] font-semibold text-slate-500 mb-1">Nama Lengkap Balita <span class="text-rose-500">*</span></label>
                                ...
                                <div>
                                    <label class="block text-[11px] font-semibold text-slate-500 mb-1">NIK Balita</label>
                                    <input type="text" x-model="newPatient.nik" placeholder="16 digit NIK" maxlength="20"
                                        class="w-full px-3.5 py-2.5 text-xs border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 bg-slate-50 focus:bg-white transition-all">
                                </div>
                                <div>
                                    <label class="block text-[11px] font-semibold text-slate-500 mb-1">Nama Orang Tua</label>
                                ...
                                <div>
                                    <label class="block text-[11px] font-semibold text-slate-500 mb-1">Tanggal Lahir</label>
                                    <input type="date" x-model="newPatient.tanggal_lahir"
                                        class="w-full px-3.5 py-2.5 text-xs border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 bg-slate-50 focus:bg-white transition-all">
                                </div>
                                <div>
                                    <label class="block text-[11px] font-semibold text-slate-500 mb-1">Desa / Kelurahan</label>
                            ...
                            <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest pt-2">Pengukuran Terkini</p>
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                <div>
                                    <label class="block text-[11px] font-semibold text-slate-500 mb-1">Berat Badan (kg)</label>
                                    <input type="number" step="0.01" x-model="newPatient.berat" placeholder="Contoh: 9.5"
                                        class="w-full px-3.5 py-2.5 text-xs border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 bg-slate-50 focus:bg-white transition-all">
                                </div>
                                <div>
                                    <label class="block text-[11px] font-semibold text-slate-500 mb-1">Tinggi Badan (cm)</label>
                                    <input type="number" step="0.1" x-model="newPatient.tinggi" placeholder="Contoh: 75.2"
                                        class="w-full px-3.5 py-2.5 text-xs border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 bg-slate-50 focus:bg-white transition-all">
                                </div>
                                <div>
                                ...
                                <div>
                                    <label class="block text-[11px] font-semibold text-slate-500 mb-1">Kategori TB/U</label>
                        ...
                        <div x-show="addModalTab === 'ai'" class="space-y-3">
                            <div class="p-3.5 bg-emerald-50 border border-emerald-100 rounded-xl text-xs text-emerald-800 leading-relaxed">
                                Tulis deskripsi data balita secara bebas. Contoh:<br>
                                <span class="mt-1.5 block text-emerald-600 italic">"Balita bernama Muhammad Rizki, laki-laki lahir 12 Maret 2024, anak dari Bpk Ridwan. Warga Desa Cijantra Posyandu Melati. Berat badan saat ini 7.2 kg, tinggi 68 cm, LiLA 11.5 cm, status TB/U sangat pendek, BB/U kurang."</span>
                            </div>

                            {{-- Step indicator --}}
                            <div class="flex items-center gap-2 text-[11px]">
                                <span :class="aiAddStep === 'prompt' ? 'bg-emerald-600 text-white' : 'bg-emerald-100 text-emerald-600'"
                                ...
                                <span :class="aiAddStep === 'preview' ? 'bg-emerald-600 text-white' : 'bg-emerald-100 text-emerald-600'"
                                ...
                                <div class="max-h-72 overflow-y-auto border border-slate-200 rounded-xl divide-y divide-slate-100">
                                    <template x-for="[key, val] in Object.entries(newPatient).filter(([k,v]) => v !== null && v !== '' && v !== undefined)" :key="key">
                                        <div class="flex items-start gap-2 px-3.5 py-2.5 hover:bg-slate-50">
                                            ...
                                            <input type="text" :value="val" @change="newPatient[key] = $event.target.value"
                    ...
                    <div class="px-6 pb-5 pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
                        ...
                        <div class="flex items-center gap-2 ml-auto">
                            ...
                            <button x-show="addModalTab === 'ai' && aiAddStep === 'prompt'" @click="runStuntingAiParse()"
                            ...
                            <button x-show="addModalTab === 'ai' && aiAddStep === 'preview'" @click="saveNewPatient()" type="button"
        ...
        <div x-show="showViewModal" x-cloak class="fixed inset-0 z-[9999] overflow-y-auto" style="display: none;">
            <div class="min-h-screen px-4 text-center flex items-center justify-center py-8">
                ...
                <div class="inline-block w-full max-w-2xl p-6 my-8 text-left align-middle transition-all transform bg-white shadow-2xl rounded-3xl z-10 border border-slate-100 flex flex-col max-h-[90vh]">
                    ...
                    <div class="mt-4 overflow-y-auto space-y-4 pr-1 text-xs">
                        <div class="p-4 rounded-2xl bg-gradient-to-r from-emerald-50 via-teal-50 to-green-50 border border-emerald-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                            <div>
                                <div class="flex items-center gap-2">
                                    <span class="text-base font-bold text-slate-900" x-text="viewingPatient?.nama || '-'"></span>
                                    <span class="px-2 py-0.5 rounded-full text-[10px] font-bold border bg-emerald-100 text-emerald-800 border-emerald-200"
                                        x-text="viewingPatient?.jenis_kelamin === 'L' ? 'Laki-laki ♂' : 'Perempuan ♀'"></span>
                                </div>
                                <div class="text-slate-500 text-[11px] mt-0.5" x-text="'NIK: ' + (viewingPatient?.nik || '-') + ' • Ortu: ' + (viewingPatient?.nama_ortu || '-')"></div>
                            </div>
                            <div>
                                <span class="px-3 py-1 rounded-xl font-bold text-xs border inline-flex items-center gap-1.5 shadow-2xs"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="p-3.5 bg-slate-50 rounded-2xl border border-slate-200/80 space-y-2.5">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-[11px]">
                                    <div><span class="text-slate-400 block">Tgl Lahir</span><span class="font-semibold text-slate-700" x-text="formatDate(viewingPatient?.tanggal_lahir)"></span></div>
                                    <div><span class="text-slate-400 block">Usia Ukur</span><span class="font-semibold text-slate-700" x-text="(viewingPatient?.usia_saat_ukur || '-') + ' Bulan'"></span></div>
                                    <div><span class="text-slate-400 block">Desa</span><span class="font-semibold text-slate-700" x-text="viewingPatient?.desa || '-'"></span></div>
                                    <div><span class="text-slate-400 block">Posyandu</span><span class="font-semibold text-slate-700" x-text="viewingPatient?.posyandu || '-'"></span></div>
                                    <div class="col-span-2"><span class="text-slate-400 block">Alamat</span><span class="font-medium text-slate-700" x-text="viewingPatient?.alamat || '-'"></span></div>
                                </div>
                            </div>
                            ...
                            <div class="p-3.5 bg-slate-50 rounded-2xl border border-slate-200/80 space-y-2.5">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-[11px]">
                                    <div><span class="text-slate-400 block">Berat Badan</span><span class="font-bold text-slate-800" x-text="viewingPatient?.berat ? Number(viewingPatient.berat).toFixed(2) + ' kg' : '-'"></span></div>
                                    <div><span class="text-slate-400 block">Tinggi Badan</span><span class="font-bold text-slate-800" x-text="viewingPatient?.tinggi ? Number(viewingPatient.tinggi).toFixed(1) + ' cm' : '-'"></span></div>
                                    <div><span class="text-slate-400 block">LiLA</span><span class="font-semibold text-slate-700" x-text="viewingPatient?.lila ? Number(viewingPatient.lila).toFixed(1) + ' cm' : '-'"></span></div>
