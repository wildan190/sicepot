        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                ...
                <div class="flex items-center gap-2" id="piesocket-nav-status">
                    ...
                    <div id="piesocket-badge" class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 text-slate-600 border border-slate-200 text-[11px] font-semibold rounded-xl">
            ...
            <div class="-me-2 flex items-center gap-2 sm:hidden">
                <button type="button" 
                    ...
                    <svg class="w-3 h-3 text-rose-600 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
                    </svg>
                    <span>Alert HP</span>
                </button>
                <div id="piesocket-badge-mobile" class="w-2.5 h-2.5 rounded-full bg-slate-400" title="Status WebSocket"></div>
