                    ...
                    <div class="inline-block w-full max-w-2xl my-8 text-left align-middle transition-all transform bg-white shadow-2xl rounded-3xl z-10 border border-slate-100 overflow-hidden">
                        ...
                        <div class="px-6 pt-6 pb-4 border-b border-slate-100 flex items-start justify-between gap-3">
                            <div>
                                ...
                                <p class="text-xs text-slate-500 mt-0.5">Deskripsikan data ibu hamil secara bebas, AI akan mengisi form secara otomatis</p>
                            </div>
                            <button @click="showAddModal = false" class="p-1.5 text-slate-400 hover:text-slate-600 rounded-lg hover:bg-slate-100 cursor-pointer shrink-0">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="px-6 py-5 space-y-4">
                            ...
                            <div class="flex items-center gap-2 text-[11px]">
                                <span :class="aiAddStep === 'prompt' ? 'bg-pink-600 text-white' : 'bg-pink-100 text-pink-600'"
                                ...
                                <span :class="aiAddStep === 'preview' ? 'bg-pink-600 text-white' : 'bg-pink-100 text-pink-600'"
                            ...
                            <div x-show="aiAddStep === 'prompt'" class="space-y-3">
                                <div class="p-3.5 bg-pink-50 border border-pink-100 rounded-xl text-xs text-pink-700 leading-relaxed">
                                    Tulis deskripsi ibu hamil seperti berbicara kepada rekan bidan. Contoh:<br>
                                    <span class="mt-1.5 block text-pink-500 italic">"Ny. Siti Rahayu, 28 tahun, NIK 3603xx, G2P1A0, HPHT 10 Maret 2025, HPL 15 Desember 2025, LiLA 23 cm, Hb 10.2, warga Pagedangan Kab. Tangerang, kunjungan K2, faktor risiko KEK dan tensi 140/90."</span>
                                </div>
                                <div>
                        ...
                        <div class="px-6 pb-6 pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
                            ...
                            <div class="flex items-center gap-2 ml-auto">
                                ...
                                <button x-show="aiAddStep === 'prompt'"
                                    @click="runAncAiParse()" type="button"
